...
if not st.session_state.is_analyzed:
    ...
    # Handle message sending - FIXED: Only process if button clicked AND input is new
    if send_button and user_input.strip() and user_input != st.session_state.last_user_input:
